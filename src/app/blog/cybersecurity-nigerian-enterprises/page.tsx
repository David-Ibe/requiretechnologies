        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 2, name: 'Cybersecurity for Nigerian Enterprises', item: (process.env.NEXT_PUBLIC_SITE_URL || 'https://requiretechnologies.com') + '/blog/cybersecurity-nigerian-enterprises' }
            ]
          })
        }}
      />
